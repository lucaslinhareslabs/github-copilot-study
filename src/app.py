...
activities = {
    ...
    "Basketball Training": {
        "description": "Improve basketball skills with drills and scrimmages",
    ...
    "Drama Club": {
        "description": "Rehearse scenes and prepare for school theatre productions",
    ...
    "Debate Team": {
        "description": "Practice public speaking and participate in debate tournaments",
